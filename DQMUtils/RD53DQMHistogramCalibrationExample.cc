/*!
        \file                RD53DQMHistogramCalibrationExample.cc
...
//========================================================================================================================
RD53DQMHistogramCalibrationExample::RD53DQMHistogramCalibrationExample ()
{
}
...
//========================================================================================================================
void RD53DQMHistogramCalibrationExample::book(TFile *theOutputFile, const DetectorContainer &theDetectorStructure, std::map<std::string, double> pSettingsMap)
{
    ...
    fRowStart     = pSettingsMap["ROWstart"];
    fRowStop      = pSettingsMap["ROWstop"];
    fColStart     = pSettingsMap["COLstart"];
    fColStop      = pSettingsMap["COLstop"];
...
//========================================================================================================================
void RD53DQMHistogramCalibrationExample::fillCalibrationExamplePlots(DetectorDataContainer &theHitContainer)
{
    for(auto board : theHitContainer) //for on boards - begin 
    {
        ...
        for(auto module: *board) //for on module - begin 
        {
            ...
            for(auto chip: *module) //for on chip - begin 
            {
                ...
                TH2F *chipHitHistogram = fDetectorHitHistograms.at(boardIndex)->at(moduleIndex)->at(chipIndex)
                    ->getSummary<HistContainer<TH2F>>().fTheHistogram;
...
//========================================================================================================================
void RD53DQMHistogramCalibrationExample::process()
{
    ...
    for(auto board : fDetectorHitHistograms) //for on boards - begin 
    {
        ...
        for(auto module: *board) //for on module - begin 
        {
            ...
            for(auto chip: *module)  //for on chip - begin 
            {
                ...
                chipHitHistogram->DrawCopy("colz");
            } //for on chip - end 
        } //for on module - end 
    } //for on boards - end 
}
...
//========================================================================================================================
void RD53DQMHistogramCalibrationExample::reset(void)
{
    // Clear histograms if needed
}

//========================================================================================================================
bool RD53DQMHistogramCalibrationExample::fill(std::vector<char>& dataBuffer)
{
    // SoC utilities only - BEGIN
    // THIS PART IT IS JUST TO SHOW HOW DATA ARE DECODED FROM THE TCP STREAM WHEN WE WILL GO ON THE SOC
    // IF YOU DO NOT WANT TO GO INTO THE SOC WITH YOUR CALIBRATION YOU DO NOT NEED THE FOLLOWING COMMENTED LINES
    ...
    ChannelContainerStream<uint32_t>  theHitStreamer("RD53CalibrationExample");
