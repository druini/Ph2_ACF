...
void DataReadbackOptimizationHistograms::book(TFile* theOutputFile, const DetectorContainer& theDetectorStructure, const Ph2_System::SettingsMap& settingsMap)
{
    ...
    bookImplementer(theOutputFile, theDetectorStructure, TAP0, hTAP0scan, "TAP0 - driver", "Bit Error Rate");
    ...
    bookImplementer(theOutputFile, theDetectorStructure, TAP1, hTAP1scan, "TAP1 - pre-emphasis-1", "Bit Error Rate");
    ...
    bookImplementer(theOutputFile, theDetectorStructure, TAP2, hTAP2scan, "TAP2 - pre-emphasis-2", "Bit Error Rate");
}
