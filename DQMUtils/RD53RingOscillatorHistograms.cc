...
void RingOscillatorHistograms::fillRO(double trimOscCounts[42][16], double trimOscFrequency[42][16], double trimVoltage[16])
{
    ...
    {
        TGraph* freqPlot = new TGraph(8, trimVoltage, trimOscFrequency[ringOsc]);
