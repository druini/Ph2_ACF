...
namespace Ph2_HwInterface {
    ...
    uint32_t BeBoardInterface::ReadData ( BeBoard* pBoard, bool pBreakTrigger, std::vector<uint32_t>& pData, bool wait)
    {
        setBoard ( pBoard->getBeBoardIdentifier() );
        fBoardFW->ReadData ( pBoard, pBreakTrigger, pData, wait);
    }
