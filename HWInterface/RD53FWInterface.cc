...
namespace Ph2_HwInterface
{
  ...
  void RD53FWInterface::WriteChipCommand (const std::vector<uint16_t>& data, unsigned int nCmd=1, unsigned int moduleId=0xFF) {
  ...
  uint8_t lane2chipId(uint8_t chip_id) {
    switch (chip_id) {
      case 0:
        return 0;
      case 1:
