...
namespace Ph2_HwInterface
{
  ...
  public:
    ...
    bool     WriteChipReg              (Chip* pChip, const std::string& pRegNode, const uint16_t data, bool pVerifLoop = false)               override;
    ...
    bool     WriteRD53Mask             (RD53* pRD53, bool doSparse, bool doDefault, bool pVerifLoop = false);
    bool     WriteRD53Reg              (RD53* pRD53, const std::string& pRegNode, const std::vector<uint16_t>* dataVec, size_t nCmd = 1);
