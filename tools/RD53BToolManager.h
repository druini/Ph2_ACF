...
struct ToolManager : public ToolManagerBase {
    ToolManager(SystemController& system, const toml::value& config, bool showPlots = true, std::string resultsPath = "Results/")
      : ToolManagerBase(system, config, std::move(resultsPath)) 
