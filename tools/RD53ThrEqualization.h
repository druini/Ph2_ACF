...
{
 public:
  ThrEqualization(const char* fileRes, const char* fileReg, size_t rowStart, size_t rowEnd, size_t colStart, size_t colEnd, size_t nPixels2Inj, size_t nEvents, DetectorDataContainer* newVCal = nullptr);
  ~ThrEqualization();
