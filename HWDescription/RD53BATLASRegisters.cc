...
const std::array<Register, 256> ATLASRegisters::Regs = {
    ...
    Register{ "CdrConf", 58, 5, 0, false, RegType::ReadWrite }, 
    ...
    Register{ "ServiceDataConf", 62, 9, 50, false, RegType::ReadWrite }, 
    ...
    Register{ "AuroraConfig", 81, 13, 359, false, RegType::ReadWrite }, 
    ...
    Register{ "SER_SEL_OUT", 94, 8, 85, false, RegType::ReadWrite }, 
    Register{ "CML_CONFIG", 95, 8, 1, false, RegType::ReadWrite }, 
