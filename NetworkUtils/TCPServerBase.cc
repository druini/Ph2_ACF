...
//========================================================================================================================
TCPServerBase::TCPServerBase(int serverPort, unsigned int maxNumberOfConnections)
...
TCPServerBase::~TCPServerBase(void)
{
	...
	shutdownAccept();
	std::cout << __PRETTY_FUNCTION__ << "Closing the network server socket: " << getSocketId() << std::endl;
	while (fAcceptFuture.wait_for(std::chrono::milliseconds(100)) == std::future_status::timeout)
...
//========================================================================================================================
// void TCPServerBase::startAcceptConnections(void)
// {
// 	fAcceptFuture = std::async(std::launch::async, &TCPServerBase::acceptConnections, this);
// }
