...
namespace Ph2_HwInterface
{
  ...
  RD53Event::RD53Event ( const BeBoard* pBoard,  uint32_t pNbCbc, const std::vector<uint32_t>& list )
  {
    SetEvent ( pBoard, pNbCbc, list );
  }
 
  void RD53Event::SetEvent ( const BeBoard* pBoard, uint32_t pNbCbc, const std::vector<uint32_t>& list )
  {
    // block size
  ...
  std::string RD53Event::HexString() const
  {
    //std::stringbuf tmp;
    //std::ostream os ( &tmp );
  ...
  std::string RD53Event::DataHexString ( uint8_t pFeId, uint8_t pCbcId ) const
  {
    std::stringbuf tmp;
    std::ostream os ( &tmp );
  ...
  // NOT READY (what is i??????????)
  bool RD53Event::Error ( uint8_t pFeId, uint8_t pCbcId, uint32_t i ) const
  {
    return Bit ( pFeId, pCbcId, D19C_OFFSET_ERROR_CBC3 );
  }

  uint32_t RD53Event::Error ( uint8_t pFeId, uint8_t pCbcId ) const
  {
  ...
  uint32_t RD53Event::PipelineAddress ( uint8_t pFeId, uint8_t pCbcId ) const
  {
    uint16_t cKey = encodeId (pFeId, pCbcId);
    EventDataMap::const_iterator cData = fEventDataMap.find (cKey);
  ...
  bool RD53Event::DataBit ( uint8_t pFeId, uint8_t pCbcId, uint32_t i ) const
  {
    if ( i >= NCHANNELS )
      return 0;
  ...
  std::string RD53Event::DataBitString ( uint8_t pFeId, uint8_t pCbcId ) const
  {
    uint16_t cKey = encodeId (pFeId, pCbcId);
    EventDataMap::const_iterator cData = fEventDataMap.find (cKey);
  ...
  std::vector<bool> RD53Event::DataBitVector ( uint8_t pFeId, uint8_t pCbcId ) const
  {
  ...
  std::vector<bool> RD53Event::DataBitVector ( uint8_t pFeId, uint8_t pCbcId, const std::vector<uint8_t>& channelList ) const
  {
    std::vector<bool> blist;
  ...
  std::string RD53Event::GlibFlagString ( uint8_t pFeId, uint8_t pCbcId ) const
  {
    return "";
  }


  std::string RD53Event::StubBitString ( uint8_t pFeId, uint8_t pCbcId ) const
  {
    std::ostringstream os;
  ...
  bool RD53Event::StubBit ( uint8_t pFeId, uint8_t pCbcId ) const
  {
  ...
  std::vector<Stub> RD53Event::StubVector (uint8_t pFeId, uint8_t pCbcId) const
  {
  ...
  uint32_t RD53Event::GetNHits (uint8_t pFeId, uint8_t pCbcId) const
  {
    uint32_t cNHits = 0;
    uint16_t cKey = encodeId (pFeId, pCbcId);
    EventDataMap::const_iterator cData = fEventDataMap.find (cKey);
  ...
  std::vector<uint32_t> RD53Event::GetHits (uint8_t pFeId, uint8_t pCbcId) const
  {
  ...
  void RD53Event::printCbcHeader (std::ostream& os, uint8_t pFeId, uint8_t pCbcId) const
  {
    uint16_t cKey = encodeId (pFeId, pCbcId);
    EventDataMap::const_iterator cData = fEventDataMap.find (cKey);
  ...
  void RD53Event::print ( std::ostream& os) const
  {
  ...
  std::vector<Cluster> RD53Event::getClusters ( uint8_t pFeId, uint8_t pCbcId) const
  {
  ...
  SLinkEvent RD53Event::GetSLinkEvent (  BeBoard* pBoard) const
  {
